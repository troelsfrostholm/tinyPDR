...
module krome_commons
  ...
  !  KROME 14.08.dev on 2018-10-20 12:06:25
  !  Changeset b21f657
  ...
  !xsec for H2 -> H+ + H + E
  real*8,allocatable::xsec230_val(:)
  real*8::xsec230_Emin
  real*8::xsec230_idE
  integer::xsec230_n
...
contains
  ...
  function coe(n)
    ...
    !CO -> CO_ice
    k(209) = small + (krate_stickSi(n(:),idx_CO,tabTdust))

    !CO_ice -> CO
    k(210) = small + (krate_evaporation(n(:),idx_CO,tabTdust))

    !H2O -> H2O_ice
    k(211) = small + (krate_stickSi(n(:),idx_H2O,tabTdust))

    !H2O_ice -> H2O
    k(212) = small + (krate_evaporation(n(:),idx_H2O,tabTdust))

    !CO_ice -> CO
    k(213) = small + (krate_nonthermal_evaporation(idx_CO,1.78d0&
        *user_G0, user_Av, user_crate, 1d-3))

    !H -> H+ + E
    k(214) = small + (photoBinRates(1))

    !HE -> HE+ + E
    k(215) = small + (photoBinRates(2))

    !HE+ -> HE++ + E
    k(216) = small + (photoBinRates(3))

    !O -> O+ + E
    k(217) = small + (photoBinRates(4))

    !C -> C+ + E
    k(218) = small + (photoBinRates(5))

    !H2 -> H2+ + E
    k(219) = small + (photoBinRates(6))

    !H- -> H + E
    k(220) = small + (photoBinRates(7))

    !CH -> C + H
    k(221) = small + (photoBinRates(8))

    !CH -> CH+ + E
    k(222) = small + (photoBinRates(9))

    !C2 -> C + C
    k(223) = small + (photoBinRates(10))

    !OH -> O + H
    k(224) = small + (photoBinRates(11))

    !OH -> OH+ + E
    k(225) = small + (photoBinRates(12))

    !H2O -> OH + H
    k(226) = small + (photoBinRates(13))

    !H2O -> H2O+ + E
    k(227) = small + (photoBinRates(14))

    !O2 -> O2+ + E
    k(228) = small + (photoBinRates(15))

    !O2 -> O + O
    k(229) = small + (photoBinRates(16))

    !H2 -> H+ + H + E
    k(230) = small + (photoBinRates(17))

    !CO -> C + O
    k(231) = small + (user_gamma_CO)

    !H2 -> H + H
    k(232) = small + (user_gamma_H2)

    !H2+ -> H + H+
    k(233) = small + (user_G0*1.1d-9*exp(-1.9&
        *user_Av))

    !H3+ -> H2 + H+
    k(234) = small + (user_G0*4.9d-13*exp(-1.8&
        *user_Av))

    !H3+ -> H2+ + H
    k(235) = small + (user_G0*4.9d-13*exp(-2.3&
        *user_Av))

    !C- -> C + E
    k(236) = small + (user_G0*2.4d-7*exp(-.9&
        *user_Av))

    !CH+ -> C + H+
    k(237) = small + (user_G0*2.6d-10*exp(-2.5&
        *user_Av))

    !CH2 -> CH + H
    k(238) = small + (user_G0*7.1d-10*exp(-1.7&
        *user_Av))

    !CH2 -> CH2+ + E
    k(239) = small + (user_G0*5.9d-10*exp(-2.3&
        *user_Av))

    !CH2+ -> CH+ + H
    k(240) = small + (user_G0*4.6d-10*exp(-1.7&
        *user_Av))
    ...
    !CH3+ -> CH+ + H2
    k(242) = small + (user_G0*1d-9*exp(-1.7&
        *user_Av))

    !O- -> O + E
    k(243) = small + (user_G0*2.4d-7*exp(-.5&
        *user_Av))

    !OH+ -> O + H+
    k(244) = small + (user_G0*1d-12*exp(-1.8&
        *user_Av))
    ...
    !H2O+ -> O+ + H2
    k(247) = small + (user_G0*5.d-11*HnOj)

    !H2O+ -> OH+ + H
    k(248) = small + (user_G0*1.5d-10*HnOj)
    ...
    !H3O+ -> H2O+ + H
    k(251) = small + (user_G0*7.5d-12*HnOj)

    !H3O+ -> OH+ + H2
    k(252) = small + (user_G0*2.5d-11*HnOj)
    ...
    !C + O+ -> CO+
    if(Tgas.GE.2d3) then
      k(279) = small + (2.14d-27&
          *(Tgas&
          /3d2)**(-3.08)*exp(2114./Tgas)*ntot)
    end if

    !H + O -> OH
    k(280) = small + (4.33d-32*(T32)**(-1)*ntot)

    !OH + H -> H2O
    k(281) = small + (2.56d-31*(T32)**(-2)*ntot)

    !O + O -> O2
    k(282) = small + (9.2d-34*(T32)**(-1)*ntot)
  ...
  subroutine load_arrays()
    ...
    arr_r1(1:282) = (/5,20,20,6,21,21,21,21,6,6,7,7,7,7,36,5,2,5&
        ...
        ,8,8,8,8,23,23,23,23,9,9,9,10,5,40,40,40,40,40,5,6,21,9,8,7,2&
        ...
        ,9/)
    arr_r2(1:282) = (/1,1,1,1,1,1,1,5,20,20,6,21,21,21,1&
        ...
        ,5,7,9,5,7,8,20,20,1,5,7,8,9,5,7,9,9,1,5,9,5,5,40,40,40,40,40&
        ,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40&
        ,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40&
        ,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,8,8,9&
        ,9,9,9,24,24,9,5,9/)
    arr_r3(1:282) = (/40,40,40,40,40,40&
        ,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40&
        ...
        ,40/)
    arr_p1(1:282) = (/20,5,5,21,6,6,36,6,21,21,5,6,6,21&
        ...
        ,30,30,4,10,17,16,7,40,40,40,40,40,20,21,36,24,23,22,5,8,28,8&
        ,9,32,10,33,35,9,20,8,5,5,7,22,8,8,12,29,28,29,28,9,9,22,20&
        ,24,32,20,22,33,32,20,21,24,8,30,8,5,20,22,23,8,9,35,9,29,10&
        ,11,26,5,14,14,11,11,30,30,30,30,10,16&
        ,17/)
    arr_p2(1:282) = (/1,40,40,1,40,40,1,20,5,5,5,22,5,5&
        ...
        ,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,1,1,1,1,1&
        ,1,1,5,1,8,5,1,5,1,1,9,5,9,5,20,20,5,1,20,5,1,5,5,7,1,20,9,10&
        ,7,5,16,10,5,7,1,1,1,9,1,8,5,2,1,1,5,9,1,5,1,5,5,1,20,40,40&
        ,40,40,40,40,40,40,40,40,40/)
    arr_p3(1:282) = (/1,40,40,1&
        ,40,40,1,40,40,40,6,40,20,5,40,40,40,40,40,40,40,40,1,5,1,1,1&
        ,40,40,40,40,40,5,40,40,40,40,40,40,40,40,1,1,40,40,40,40,40&
        ,40,40,40,5,40,40,40,40,40,40,40,40,40,40,40,5,40,40,40,40,40&
        ,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40&
        ,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40&
        ,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40&
        ,40,40,40,40,40,40,23,23,28,28,6,40,40,5,5,40,40,20,20,5,5,40&
        ,40,40,40,9,9,24,40,40,40,40,40,5,40,40,40,5,40,40,5,40,40,40&
        ,5,5,7,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,20,40&
        ,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40&
        ,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,1,40,40,40,40&
        ,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40&
        ,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,1,40,40,40&
...
call load_xsec("swri_C__C+_E.dat", xsec218_val, xsec218_Emin, xsec218_n, xsec218_idE)
call load_xsec("swri_H2__H2+_E.dat", xsec219_val, xsec219_Emin, xsec219_n, xsec219_idE)
call load_xsec("swri_H-__H_E.dat", xsec220_val, xsec220_Emin, xsec220_n, xsec220_idE)
call load_xsec("swri_CH__C_H.dat", xsec221_val, xsec221_Emin, xsec221_n, xsec221_idE)
call load_xsec("swri_CH__CH+_E.dat", xsec222_val, xsec222_Emin, xsec222_n, xsec222_idE)
call load_xsec("swri_C2__C_C.dat", xsec223_val, xsec223_Emin, xsec223_n, xsec223_idE)
call load_xsec("swri_OH__O_H.dat", xsec224_val, xsec224_Emin, xsec224_n, xsec224_idE)
call load_xsec("swri_OH__OH+_E.dat", xsec225_val, xsec225_Emin, xsec225_n, xsec225_idE)
call load_xsec("swri_H2O__OH_H.dat", xsec226_val, xsec226_Emin, xsec226_n, xsec226_idE)
call load_xsec("swri_H2O__H2O+_E.dat", xsec227_val, xsec227_Emin, xsec227_n, xsec227_idE)
call load_xsec("swri_O2__O2+_E.dat", xsec228_val, xsec228_Emin, xsec228_n, xsec228_idE)
call load_xsec("swri_O2__O_O.dat", xsec229_val, xsec229_Emin, xsec229_n, xsec229_idE)
call load_xsec("swri_H2__H+_H_E.dat", xsec230_val, xsec230_Emin, xsec230_n, xsec230_idE)
...
do j=1,nPhotoBins
  ...
  !C -> C+ + E
  kk = 0d0
  if(energy_eV>0.0.and.energy_eV<1.d8) kk = xsec_interp(energyL, energyR, xsec218_val(:), xsec218_Emin,xsec218_idE, dshift(idx_C))
  !$omp parallel
  photoBinJTab(5,j) = kk
  !$omp end parallel
  ...
  !H2 -> H2+ + E
  kk = 0d0
  if(energy_eV>0.0.and.energy_eV<1.d8) kk = xsec_interp(energyL, energyR, xsec219_val(:), xsec219_Emin,xsec219_idE, dshift(idx_H2))
  !$omp parallel
  photoBinJTab(6,j) = kk
  !$omp end parallel
  ...
  !H- -> H + E
  kk = 0d0
  if(energy_eV>0.0.and.energy_eV<1.d8) kk = xsec_interp(energyL, energyR, xsec220_val(:), xsec220_Emin,xsec220_idE, dshift(idx_Hk))
  !$omp parallel
  photoBinJTab(7,j) = kk
  !$omp end parallel
  ...
  !CH -> CH+ + E
  kk = 0d0
  if(energy_eV>0.0.and.energy_eV<1.d8) kk = xsec_interp(energyL, energyR, xsec222_val(:), xsec222_Emin,xsec222_idE, dshift(idx_CH))
  !$omp parallel
  photoBinJTab(9,j) = kk
  !$omp end parallel
  ...
  !C2 -> C + C
  kk = 0d0
  if(energy_eV>0.0.and.energy_eV<1.d8) kk = xsec_interp(energyL, energyR, xsec223_val(:), xsec223_Emin,xsec223_idE, dshift(idx_C2))
  !$omp parallel
  ...
  !OH -> OH+ + E
  kk = 0d0
  if(energy_eV>0.0.and.energy_eV<1.d8) kk = xsec_interp(energyL, energyR, xsec225_val(:), xsec225_Emin,xsec225_idE, dshift(idx_OH))
  !$omp parallel
  ...
  !H2O -> H2O+ + E
  kk = 0d0
  if(energy_eV>0.0.and.energy_eV<1.d8) kk = xsec_interp(energyL, energyR, xsec227_val(:), xsec227_Emin,xsec227_idE, dshift(idx_H2O))
  !$omp parallel
  ...
  !O2 -> O + O
  kk = 0d0
  if(energy_eV>0.0.and.energy_eV<1.d8) kk = xsec_interp(energyL, energyR, xsec229_val(:), xsec229_Emin,xsec229_idE, dshift(idx_O2))
  !$omp parallel
  ...
  !H2 -> H+ + H + E
  kk = 0d0
  if(energy_eV>0.0.and.energy_eV<1.d8) kk = xsec_interp(energyL, energyR, xsec230_val(:), xsec230_Emin,xsec230_idE, dshift(idx_H2))
  !$omp parallel
...
!H -> H+ + E
rateEvaluateOnce(253) = small + (4.6d-1&
    *user_crate)

!HE -> HE+ + E
rateEvaluateOnce(254) = small + (5.d-1&
    *user_crate)

!O -> O+ + E
rateEvaluateOnce(255) = small + (2.8d0&
    *user_crate)

!CO -> C + O
rateEvaluateOnce(256) = small + (5d0&
    *user_crate)

!CO -> CO+ + E
rateEvaluateOnce(257) = small + (3d0&
    *user_crate)

!C2 -> C + C
rateEvaluateOnce(258) = small + (2.37d2&
    *user_crate)

!H2 -> H + H
rateEvaluateOnce(259) = small + (1d-1&
    *user_crate)

!H2 -> H+ + H-
rateEvaluateOnce(260) = small + (3d-4&
    *user_crate)

!H2 -> H2+ + E
rateEvaluateOnce(261) = small + (9.3d-1&
    *user_crate)

!C -> C+ + E
rateEvaluateOnce(262) = small + (1.02d3&
    *user_crate)

!CH -> C + H
rateEvaluateOnce(263) = small + (7.3d2&
    *user_crate)

!O2 -> O + O
rateEvaluateOnce(264) = small + (7.5d2&
    *user_crate)

!O2 -> O2+ + E
rateEvaluateOnce(265) = small + (1.17d2&
    *user_crate)

!OH -> O + H
rateEvaluateOnce(266) = small + (5.1d2&
    *user_crate)

!CH2 -> CH2+ + E
rateEvaluateOnce(267) = small + (5d2&
    *user_crate)

!H2O -> OH + H
rateEvaluateOnce(268) = small + (9.7d2&
    *user_crate)

!HCO -> CO + H
rateEvaluateOnce(269) = small + (4.21d2&
    *user_crate)

!HCO -> HCO+ + E
rateEvaluateOnce(270) = small + (1.17d3&
    *user_crate)

!H2 -> H + H+ + E
rateEvaluateOnce(271) = small + (9.3d-1&
    *user_crate)
...
dn(idx_C) = &
    ...
    -2.d0*k(273)*n(idx_C)*n(idx_C) &
    -k(274)*n(idx_C)*n(idx_O) &
    -k(275)*n(idx_C)*n(idx_O) &
    -k(278)*n(idx_C)*n(idx_Oj) &
    -k(279)*n(idx_C)*n(idx_Oj)
...
dn(idx_O) = &
    ...
    -k(277)*n(idx_Cj)*n(idx_O) &
    -k(280)*n(idx_H)*n(idx_O) &
    -2.d0*k(282)*n(idx_O)*n(idx_O)
...
dn(idx_CO) = &
    dnChem_CO &
    -n(idx_CO)*(k(209)+k(213)) &
    +k(213)*n(idx_CO_total)
...
dn(idx_H2O) = &
    dnChem_H2O &
    -n(idx_H2O)*(k(211)+k(212)) &
    +k(212)*n(idx_H2O_total)
...
integer,parameter::krome_nrea=282
